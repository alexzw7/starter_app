...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Chatter",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC7Chatter11AppDelegate")
...
SWIFT_CLASS("_TtC7Chatter14ChattTableCell")
...
SWIFT_CLASS("_TtC7Chatter24ChattTableViewController")
@interface ChattTableViewController : UITableViewController
...
SWIFT_CLASS("_TtC7Chatter21ComposeViewController")
@interface ComposeViewController : UIViewController
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified usernameLabel;
@property (nonatomic, weak) IBOutlet UITextView * _Null_unspecified messageTextView;
- (void)viewDidLoad;
- (void)didReceiveMemoryWarning;
- (IBAction)submitClicked:(UIBarButtonItem * _Nonnull)sender;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_CLASS("_TtC7Chatter13SceneDelegate")
...
SWIFT_CLASS("_TtC7Chatter14ViewController")
